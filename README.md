...
echo "= APT::FTPArchive::Release::Label "NameXYZ";
APT::FTPArchive::Release::Suite "$codename";
APT::FTPArchive::Release::Codename "$codename";
APT::FTPArchive::Release::Architectures "amd64 arm64";
APT::FTPArchive::Release::Components "ADD_ALL_FOLDER_NAME main main-test main-dev nginx nginx-dev nginx-test php-7.1 php-7.2 php-7.3 php-7.4 php-8.0 php-8.1 php-8.2 xyz";
APT::FTPArchive::Release::Description "NameXYZ Repository New";
EOF 
